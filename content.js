    ...
    if (event.target.classList.contains("badge") && event.target.classList.contains("badgeClassSelected")) {
        ...
        if (question && mcq) {
            ...
            navigator.clipboard.writeText(
                questionText + "\n\n" + formattedOptions + "\n\nPlease provide the correct options No need of Explaination."
            ).then(() => {
                console.log("Developer By Ayushman Medcalia , Follow me on telegram https://t.me/ashokmittal , follow me on Github https://github.com/SuryanshOG , Follow me on linkedin https://www.linkedin.com/in/suryanshog/ ");
            }).catch((error) => {
